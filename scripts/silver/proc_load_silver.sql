...
Purpose: This procedure performs ETL process to populate the 'silver' schema tables
		...
		BEGIN TRY
			...
			SELECT 
				CASE WHEN cid LIKE 'NAS%' THEN SUBSTRING(cid,4,LEN(cid))  -- Remove 'NAS' prefix if present
					 ELSE cid
				END AS cid,
				CASE WHEN bdate > GETDATE() THEN NULL -- Set NULL to rows with bdate > today's date
					 ELSE bdate
				END AS bdate,
